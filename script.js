...
let buttonWidth = 80;
let fontSize = 20;
const imagePaths = ['./images/image1.gif','./images/image2.gif','./images/image3.gif','./images/image4.gif','./images/image5.jpeg','./images/image6.gif','./images/image7.gif'];
...
const getRandomNumber = (num) => {return Math.floor(Math.random() * (num + 1));};
  ...
  noButton.addEventListener("click", () => {
    ...
    if (noClickCount < 4) {
      ...
      //no button text
      const messages = ["No","Em chắc chưa?","E iuu, A nhắc em!!","Đừng say no mà e iu dấu :(","Chỉ còn say yes thôi, em ko còn cơ hội nào khác đâu :D",];
  
      if (noClickCount === 4) {
        const newButton = document.createElement("button");
        newButton.id = "runawayButton";
        newButton.textContent = "em ko còn cơ hội nào khác đâu :D...";
  ...
  yesButton.addEventListener("click", () => {
    ...
    valentineQuestion.innerHTML = `
      ...
      Congratulations!!<br>
      <span style="font-size: 20px; color: #bd1e59;">Chúc mừng e iu chiến thắng trong valentine này :D! <3</span>
    `;
